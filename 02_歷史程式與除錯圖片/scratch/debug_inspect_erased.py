...
test_dir = r"測試SKILLS_08_空白"
img_path = os.path.join(test_dir, "LINE_ALBUM_頂崁里廢棄物呈報_260128_2_ok.jpg")
img = read_image_utf8(img_path)

if img is not None:
    # Save a crop around the month digit to verify it is blank
    crop = img[580:640, 140:340]
    cv2.imwrite("debug_erased_08_img2.png", crop)
    print("Saved debug_erased_08_img2.png")
else:
